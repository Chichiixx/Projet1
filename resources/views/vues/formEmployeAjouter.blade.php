...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 well well-md">
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <label class="col-md-3 col-sm-3 control-label">Quel type de présentation
                    recherchez-vous ?</label>
                <div class="col-md-2 col-sm-2">
                    <p><input type="checkbox" name="interet" value="loc"/>Location de
                        mobilier</p>
                    <p><input type="checkbox" name="interet" value="achat"/>Achat de
                        mobilier</p>
                </div>
            </div>
            <div class="form-group">
