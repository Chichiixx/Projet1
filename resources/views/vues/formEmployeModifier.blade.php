    ...
    <div class="col-md-12 col-sm-12 well well-md">
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 col-sm-2">
                    <input type="text" name="prenom" value="{{$unEmploye->prenom}}" class="form-control"
                           required>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-2 col-sm-2">
                    <input type="password" name="passe" value="{{$unEmploye->pwd}}" class="form-control"
                           required>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-md-3 col-sm-3 control-label">Quel type de présentation recherchez-vous
                    ?</label>
                <div class="col-md-2 col-sm-2">
                    <p>
                        @if ($unEmploye->interet == 'loc')
                            <input type="checkbox" name="interet" value="loc" checked="checked"/>Location de
                            mobilier
                        @else
                        ...
                        @if ($unEmploye->interet == 'achat')
                            <input type="checkbox" name="interet" value="achat" checked="checked"/>Achat de
                            mobilier
                        @else
